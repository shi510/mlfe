...
if(USE_NNPACK)
  set(NNPACK_ROOT ${PROJECT_SOURCE_DIR}/third_party/NNPACK)
  set(NNPACK_BUILD_TESTS OFF CACHE BOOL "NNPACK TESTS BUILD" FORCE)
  add_subdirectory(${NNPACK_ROOT})
  list(APPEND mlfe_include_dirs ${NNPACK_ROOT}/include)
  list(APPEND mlfe_library_dependencies nnpack)
endif()

if(USE_XNNPACK)
  set(XNNPACK_ROOT ${PROJECT_SOURCE_DIR}/third_party/XNNPACK)
  set(XNNPACK_BUILD_BENCHMARKS OFF CACHE BOOL "XNNPACK TESTS BUILD" FORCE)
