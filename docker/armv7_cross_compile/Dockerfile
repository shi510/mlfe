...
RUN apt-get update
RUN apt-get install -y git curl gcc-8 g++-8 gcc-8-arm-linux-gnueabihf g++-8-arm-linux-gnueabihf ninja-build zip
...
RUN cmake \
    ...
    -D CMAKE_TOOLCHAIN_FILE=../cmake/tool_chain/armv7_cross.cmake \
